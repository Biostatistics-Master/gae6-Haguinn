...
Infected pea aphids exhibited distinctly larger hue angles and hence greener colors (@tbl-ANOVA, @fig-Aphids). This result supports the researchers' hypothesis that infection may lead to color change. Multiple comparisons were done because it was seen that only the infected group had a significant change in their hue when compared to both the uninfected and control group ( @tbl-Planned)
